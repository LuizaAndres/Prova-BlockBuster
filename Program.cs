...
namespace Prova_BlockBuster
{
 ...
 //lista de locações
            ...
            foreach(Cliente cliente in clientes){
                 Console.WriteLine("---------------------------------------------------------------------------");
                Console.WriteLine($"nome: {cliente.nome} \nQuantidade de filmes locados: {cliente.filmesLocados()}");
                foreach(Locacao locacao in cliente.locacoes){
                    ...
                    Console.WriteLine($"Valor da locação: {locacao.valorLocacao()}\n ");
                }
            }

            foreach(Filme film in filmes){
                Console.WriteLine($" \nNome do filme: {film.nome} \tquantidade de locações: {film.qtdLocacoes()}\n{film.sinopse}");
            }         
        }
    }
}
